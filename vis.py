...
def show2Dpose(vis_2d_poses, ax,data_type='h36m', image_size=(1280,1000),img_path=None):
...
def show3Dpose(channels, ax, radius=100, data_type='h36m', lcolor='red', rcolor='#0000ff',angles=(10,-60)):
    vals = channels
    if data_type == 'h36m':
        JOINTMAP = H36M_JOINTMAP
    else:
